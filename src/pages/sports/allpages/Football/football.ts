...
@Component({
  selector: 'sport-football',
  templateUrl: 'football.html'
})
export class SportFootball implements OnDestroy {
  // selectedItem: any;
  // football: Array<object>;
  loading:any;
  // icons: string[];
  ...
  constructor(private _http: Http, public navCtrl: NavController, public loadingCtrl: LoadingController, public navParams: NavParams, public sanitizer: DomSanitizer) {
    ...
    // this._http.get('https://script.google.com/macros/s/AKfycbygukdW3tt8sCPcFDlkMnMuNu9bH5fpt7bKV50p2bM/exec?id=1SURi6PxTX3T5NYNzHMUGF0lp9YJb4oVe8UNAZ3ZX-AU&sheet=Football')
    //             .subscribe(res => {
    //               this.football = res.json().Football;
